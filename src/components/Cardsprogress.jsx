    ...
    <div className="grid gap-4 mt-4">
      {cards.map((card, index) => (
        ...
        >
          ...
          <CircularProgressbarWithChildren className='h-24 w-24'  styles={buildStyles({
          
          pathColor: "blue",
          trailColor: "lightblue"
        })} value={70}>
            <div className="flex flex-col text-base -mt-2">
              <span>70%</span> 
              <span className='w-14 text-xs text-wrap'>Goal complete</span> 
            </div>
          ...
          <div className='text-xs my-2'>Lorem ipsum dolor sit amet</div>
          </div>
        </div>
      ))}
    </div>
